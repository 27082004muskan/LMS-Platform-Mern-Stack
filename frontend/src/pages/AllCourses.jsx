...
const AllCourses = () => {
  ...
  return (
    <div className='flex min-h-screen bg-gray-50'>
        ...
        <button className='fixed top-20 left-8 z-50 bg-white text-black px-3 py-1 rounded md:hidden border-2 border-black' onClick={()=>setIsSidebarVisible(prev=>!prev)} >
        ...
        {/* MAIN - FIXED: Reduced top padding */}
        <main className='w-full transition-all duration-300 pt-[100px] pb-[40px] flex items-start justify-center md:justify-start flex-wrap gap-6 px-[10px] ml-[260px]'>
            {
